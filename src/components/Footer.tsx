...
const Footer: FC = (): JSX.Element => {
   return (
      <footer className="p-7 flex items-center justify-end">
         <motion.div
            drag
            dragConstraints={{ left: 0, top: 0, right: 0, bottom: 0 }}
            dragElastic={0.8}
            className="w-fit text-sm cursor-default flex flex-col xl:flex-row xl:gap-3 items-end justify-end opacity-50 hover:opacity-100 transition-opacity"
         >
