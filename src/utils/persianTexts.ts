...
export const aboutMePageTexts: {
   ...
   aboutMe:
      ...
      و بطور خودآموز در سایت‌های آموزشی و یوتیوب مهارت کسب می‌کردم و بعد از وارد شدن به دانشگاه و آشنایی با حوزه طراحی سایت به سمت توسعه فرانت‌اند رفتم و در حال یادگیری بیشتر و کسب تجربه در این حوزه هستم. چطوره بریم یکم بیشتر درباره مهارت‌های من آشنا بشیم؛ پس بریم پایین‌تر`,
   projects: {
      projectsTitle: 'نمونه‌کار',
